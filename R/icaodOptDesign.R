...
#'   Additional control parameters passed to the [ICAOD::locally] function.
#'   See [ICAOD::ICA.control()] for details.
#'  @return An object of class `minimax` generated with [ICAOD::locally()].
...
td_opt <- function(param, Emax_known = F, lx = c(1, exp(-8)), ux = c(10, 1),
  ...
  icaod_opt <- ICAOD::locally(predvars = c("time", "dose"),
                              parvars = parvars,
                              fimfunc= fimfunc,
